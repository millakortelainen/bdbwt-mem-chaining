...
HEADERS = $(BDBWT)io.hh $(BDBWT)util.hh $(BDBWT)rsa1d.hh $(BDBWT)rsa2d.hh $(BDBWT)mem.hh $(BDBWT)minimizer.hh $(BDBWT)driver.hh $(BDBWT)chaining.hh

all:
	g++  -fopenmp $(EDLIB) $(HEADERS) $(BDBWT)main.cpp $(SDSL) -I ./$(BDBWT)edlib/include -o main -std=c++14
debug:
	g++  -fopenmp $(EDLIB) $(BDBWT)io.hh -g $(BDBWT)util.hh -g $(BDBWT)rsa1d.hh -g $(BDBWT)rsa2d.hh -g $(BDBWT)driver.hh -g $(BDBWT)mem.hh -g $(BDBWT)minimizer.hh -g $(BDBWT)chaining.hh -g $(BDBWT)main.cpp -g $(SDSL) -I ./$(BDBWT)edlib/include -o main -std=c++14
test:
